...
public class PointUtil {
	...
	/**
	 * @return map 新的纬度 newLat 新的经度 newLon
	 */
	public static Map<String, Double> getlatLon(double lat, double lon, double distance, double angle){
        ...
        result.put("newLat", newLat);
        result.put("newLon", newLon);
